...
# If you already have a Khulnasoft cluster setup and kubectl pointing
...
function khulnasoft_setup() {
  ...
  export KHULNASOFT_SETUP_DONE=1
}
...
[[ ${KHULNASOFT_SETUP_DONE:-0} == 1 ]] || fail_test 'Khulnasoft setup not persisted'

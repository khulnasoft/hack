...
func TestPresubmitTestMainFunc(t *testing.T) {
	...
	tcs := []testCase{{
		...
		stdout: []check{
			...
			contains("Build tests for go.khulnasoft.com/hack/test"),
			contains("Build tests for go.khulnasoft.com/hack/schema"),
			contains("Build tests for go.khulnasoft.com/hack"),
			...
			contains("👻 go run khulnasoft.dev/test-infra/tools/kntest/cmd/kntest@latest" +
		...
		stdout: []check{
			...
			contains("Unit tests for go.khulnasoft.com/hack/test"),
			contains("Unit tests for go.khulnasoft.com/hack/schema"),
			contains("Unit tests for go.khulnasoft.com/hack"),

...
var (
	...
	ErrCallerNotAllowed = errors.New("don't try use go.khulnasoft.com/hack/shell package outside of allowed places")
)
...
func isCallsiteAllowed(funcName string) error {
	validPaths := []string{
		"khulnasoft.+/test/upgrade",
		"khulnasoft(:?\\.dev/|-)hack/shell",
	}

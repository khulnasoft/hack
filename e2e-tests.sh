...
# This is a helper script for Khulnasoft E2E test scripts.
...
function teardown_test_resources() {
  ...
  if function_exists khulnasoft_teardown; then
    khulnasoft_teardown
  fi
}
...
function setup_test_cluster() {
  ...
  if function_exists khulnasoft_setup; then
    khulnasoft_setup || fail_test "Khulnasoft setup failed"
  fi

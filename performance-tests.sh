...
# Copyright 2019 The Khulnasoft Authors
#
...
# This is a helper script for Khulnasoft performance test scripts.
...
readonly PROJECT_NAME=${PROJECT_NAME:-khulnasoft-performance}
readonly SERVICE_ACCOUNT_NAME=${SERVICE_ACCOUNT_NAME:-mako-job@khulnasoft-performance.iam.gserviceaccount.com}
...
EOF
  ...
  if function_exists update_khulnasoft; then
    update_khulnasoft || abort "failed to update khulnasoft"
  fi
